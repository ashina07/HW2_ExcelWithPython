...
For the remote repository, make a github repository named HW2_ExcelWithPython, then do;

```bash
git remote add origin git@github.com:ashina07/HW2_ExcelWithPython.git
git branch -M main
...
Here's the folder structure that gets created by `cookiecutter-datascience-simple`:
	...
	├── HW2_ExcelWithPython	<- Your notebooks and scripts will live in the main project folder
